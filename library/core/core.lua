...
--- Unofficial note: In newer luanti versions, `core.*` is preferred, `core.*` existed in older versions too, really no reason to NOT lsp rename unless you got something scuffed going on
---@deprecated
---@class minetest: core
minetest = core

---@class core.SoundHandle
...
--- TODO schematic is a table containing a set of fields
---@ class schematic
